      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-700 ${
            ...
            <span className="text-[#f7c600] text-sm font-semibold tracking-widest uppercase mb-4 block">
              GET STARTED TODAY
            </span>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                <Shield className="w-5 h-5 text-[#f7c600]" />
                <span className="text-white text-sm font-medium">Licensed & Insured</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                <Award className="w-5 h-5 text-[#f7c600]" />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                href="#contact-form" 
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#f7c600] text-black font-semibold rounded-lg hover:bg-[#d4a000] transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
                Get Free Estimate
            ...
            <div id="contact-form" className="bg-white rounded-2xl shadow-2xl p-8">
              ...
              <form className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      type="text"
                      placeholder="John"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f7c600] focus:border-transparent outline-none transition-all"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f7c600] focus:border-transparent outline-none transition-all">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#f7c600] focus:border-transparent outline-none transition-all resize-none"
                  />
                </div>

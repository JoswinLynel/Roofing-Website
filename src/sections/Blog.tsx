      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <article
              key={post.id}
              className={`group bg-white rounded-xl overflow-hidden border border-gray-100 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 ${
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-video">
                ...
                <div className="absolute top-4 left-4">
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-[#f7c600] text-black text-xs font-semibold rounded-full">
              ...
              <div className="p-6">
                ...
                {/* Title */}
                <h3 className="text-xl font-bold text-black mb-3 font-['Oswald'] group-hover:text-[#f7c600] transition-colors line-clamp-2">
                  {post.title}
                </h3>

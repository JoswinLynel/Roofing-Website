          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="absolute top-4 left-4">
                <span className="px-3 py-1 bg-[#f7c600] text-black text-xs font-semibold rounded-full">
                  {project.category}
                </span>
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="transform transition-all duration-500 group-hover:translate-y-0 translate-y-4">
                  ...
                  <div className="flex items-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                    <button className="flex items-center gap-2 text-[#f7c600] text-sm font-semibold hover:underline">
                      View Details

...
const About = () => {
  ...
  return (
    ...
    >
      {/* Floating Shapes */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-[#f7c600]/5 rounded-full" />
      <div className="absolute bottom-20 right-10 w-32 h-32 bg-[#f7c600]/5 rounded-full" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={`relative transition-all duration-1000 ${
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                />
                {/* Overlay Badge */}
                <div className="absolute bottom-6 left-6 bg-[#f7c600] rounded-xl p-4 shadow-lg">
                  <p className="text-3xl font-bold text-black">20+</p>
                  <p className="text-sm font-medium text-black/80">Years Experience</p>
                </div>
              </div>

              {/* Decorative Element */}
              <div className="absolute -top-4 -right-4 w-full h-full border-2 border-[#f7c600] rounded-2xl -z-10" />
            </div>
          </div>
          ...
          <div className={`transition-all duration-1000 delay-200 ${
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Since 2004, Peak Roofing has been the trusted name in residential and commercial roofing. 
            ...
            <div className="grid sm:grid-cols-2 gap-3 mb-10">
              {keyPoints.map((point, index) => (
                ...
                >
                  <div className="w-6 h-6 bg-[#f7c600] rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div className="grid grid-cols-3 gap-6">
              {stats.map((stat, index) => (
                <div 
                  key={stat.label}
                  className={`text-center p-4 bg-gray-50 rounded-xl transition-all duration-500 hover:bg-[#f7c600]/10 ${
                    isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                  }`}
                  style={{ transitionDelay: `${index * 100 + 600}ms` }}
                >
                  <stat.icon className="w-6 h-6 text-[#f7c600] mx-auto mb-2" />

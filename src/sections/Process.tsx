    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:block relative mb-12">
          ...
          <div 
            className="absolute top-1/2 left-0 h-1 bg-[#f7c600] -translate-y-1/2 rounded-full transition-all duration-700"
            ...
            >
              ...
              <div className={`relative mb-6 transition-all duration-500 ${
                ...
                <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto transition-all duration-500 ${
                  activeStep === index 
                    ? 'bg-[#f7c600] shadow-lg shadow-[#f7c600]/30' 
                ...
                <div className={`absolute -top-2 -right-2 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-500 ${
                  activeStep === index ? 'bg-black text-white' : 'bg-gray-200 text-gray-600'
                }`}>
                  {step.number}
                </div>
              </div>
              ...
              <div className="text-center">
                <h3 className={`text-xl font-bold mb-3 font-['Oswald'] transition-colors duration-500 ${
          ...
          {steps.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-300 ${
                activeStep === index ? 'bg-[#f7c600] w-8' : 'bg-gray-300'
              }`}
            />
          ))}
        </div>
